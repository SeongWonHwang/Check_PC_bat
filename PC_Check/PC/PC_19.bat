...
for /f "tokens=3" %%A in ('reg query "HKEY_LOCAL_MACHINE\Software\policies\Microsoft\Windows NT\Terminal Services" /v "fAllowUnsolicited" 2^>nul ^| findstr "fAllowUnsolicited"') do set fAllowUnsolicitedValue=%%A
