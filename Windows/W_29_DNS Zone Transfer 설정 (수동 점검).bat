...
for /f "tokens=3" %%A in ('reg query "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\DNS Server\Zones\jinis" /v "SecureSecondaries" ^| findstr "SecureSecondaries"') do set SecureSecondariesValue=%%A
